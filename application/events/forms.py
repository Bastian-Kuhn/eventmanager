...
class EventForm(FlaskForm):
    ...
    start_time = TimeField("Beginn des Events", validators=[Optional()])
    end_date = DateField("Ende Datum")
    end_time = TimeField("Endezeit des Events", validators=[Optional()])
    difficulty = RadioField("Schwierigkeit", choices=difficulties, validators=[Optional()])
    shape = RadioField("Kondition", choices=difficulties, validators=[Optional()])
